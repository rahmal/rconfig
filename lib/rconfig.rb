...
require 'lib/rconfig/config_parser'
require 'lib/rconfig/config_hash'
require 'lib/rconfig/core_ext/hash'
...
class RConfig
          ...
          if mtime 
            File.open( filename ) do | f |
             ...
             #old way
              ...
              # STDERR.puts "RConfig: loaded #{filename.inspect} => #{val.inspect}"
  ...
  def self.parse_file conf_file
    ...
    when 'conf','config','properties'
      ConfigParser.new(conf_file).parse
    else
  ...
  #   class MyClass 
  #     @@my_config = { }
  #     RConfig.on_load(:global) do 
  #       @@my_config = { } 
  #     end
  #     def my_config
  #       @@my_config ||= something_expensive_thing_on_config(RConfig.global.foobar)
  #     end
  #   end
  #
  ...
  #
  # Ex.  RConfig[:test_mode] == 
  #        RConfig.global[:test_mode] || 
  #        RConfig.global.test_mode
  #
  ...
  # Example:
  #
  #   RConfig.global(:foo) => RConfig.with_file(:global).foo
  #   RConfig.global.foo   => RConfig.with_file(:global).foo
  #
